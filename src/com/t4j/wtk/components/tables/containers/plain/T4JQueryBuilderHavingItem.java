 ...
 * 
 */
public class T4JQueryBuilderHavingItem implements Serializable {
	...
	public T4JQueryBuilderHavingItem(String filterClause) {

		this(filterClause, null);
	}

	public T4JQueryBuilderHavingItem(String filterClause, Map<String, Object> filterParameters) {
